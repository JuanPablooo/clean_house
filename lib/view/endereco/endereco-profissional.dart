...
class EnderecoProfissional extends StatefulWidget {
  EnderecoProfissional({Key key}) : super(key: key);

  @override
  _EnderecoProfissionalState createState() => _EnderecoProfissionalState();
}

class _EnderecoProfissionalState extends State<EnderecoProfissional> {
  @override
